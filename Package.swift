...
let package = Package(
    ...
    dependencies: [
      ...
      .package(url:"https://github.com/algolia/algoliasearch-client-swift", .exact("7.0.2")),
      .package(url:"https://github.com/algolia/instantsearch-ios-insights", .exact("2.3.0"))
    ],
    targets: [
