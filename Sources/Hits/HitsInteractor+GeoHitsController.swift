...
public extension HitsInteractor where Record: Geolocated {
  ...
  func connectController<Controller: GeoHitsController>(_ controller: Controller) -> GeoHitsControllerConnection<Controller> where Controller.DataSource == HitsInteractor<Record> {
